...
<td>
					<big><a class="icones_mobile" class="{$ocultar}" href="#" onclick="editar('{$id}', '{$descricao}', '{$cliente}','{$valor}','{$data_venc}','{$frequencia}','{$saida}','{$arquivo}', '{$obs}','{$data_pgto}')" title="Editar Dados"><i class="fa fa-edit text-primary "></i></a></big>

					<big><a class="icones_mobile" href="#" onclick="mostrar('{$id}', '{$descricao}', '{$nome_pessoa}', '{$tipo_pessoa}','{$valorF}','{$data_lancF}','{$data_vencF}','{$data_pgtoF}','{$nome_usu_lanc}','{$nome_usu_pgto}','{$nome_frequencia}','{$saida}','{$arquivo}','{$pago}','{$obs}','{$pix_pessoa}','{$tel_pessoa}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<div class="dropdown" style="display: inline-block;">                      
					...
					<big><a class="{$ocultar}" href="#" onclick="baixar('{$id}', '{$valor}', '{$descricao}', '{$saida}')" title="Baixar Conta"><i class="bi bi-check-square-fill" style="color:#079934"></i></a></big>
