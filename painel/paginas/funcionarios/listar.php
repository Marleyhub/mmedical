...
<td>
	<big><a class="icones_mobile" href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$endereco}','{$nivel}','{$chave_pix}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<big><a class="icones_mobile" href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$endereco}','{$ativo}','{$dataF}', '{$senha}', '{$nivel}', '{$foto}','{$chave_pix}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, endereco, nivel, comissao, chave_pix){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, endereco, ativo, data, senha, nivel, foto, comissao, chave_pix){
