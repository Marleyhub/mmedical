...
<div class="justify-content-between">
 ...
 <a style="margin-bottom: 20px; margin-top: 20px" class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i>Adicionar Conta</a>
	  ...
	  <div style="display: inline-block; margin-bottom: 10px; margin: 10px 10px;">
		...
		<div style="display: inline-block;">
			<select class="form-select" aria-label="Default select example" name="status-busca" id="status-busca">
				...
				<option value="Não">Vencidas</option>
