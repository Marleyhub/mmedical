...
<td>
	<big><a class="icones_mobile" href="#" onclick="editar('{$id}','{$nome}','{$valor}','{$comissao}','{$dias}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, valor, comissao, dias){
		$('#mensagem').text('');
