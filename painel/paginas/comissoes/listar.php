...
<td>
	...
	<div class="dropdown" style="display: inline-block;">                      
		   ...
		   <div class="dropdown head-dpdn2" style="display: inline-block;">                      
            <a class="icones_mobile" title="Baixar Conta" href="#" aria-expanded="false" aria-haspopup="true" data-bs-toggle="dropdown" class="dropdown {$visivel}"><big><i class="fa fa-check-square text-verde "></i></big></a>
             <div  class="dropdown-menu tx-13">
                 <div style="width: 240px; padding:15px 5px 0 10px;" class="dropdown-item-text">
