...
<div class="justify-content-between">
 ...
 <a style="margin-bottom: 20px; margin-top: 20px" class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i>Adicionar <?php echo ucfirst($pag); ?></a>
			...
			<div style="float:right;margin-top: 20px">
				<button onclick="compraVenda()" type="button" title="Gerar Termo de Compra de Aparelhos" class="btn btn-success">Comp. Aparelho</button>
			</div>
...
<!-- Modal Compra Aparelho -->
<div class="modal fade" id="modalCompraVenda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel"><span id="titulo_compraVenda"></span></h4>
				<button id="btn-fechar-conta" aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span class="text-white" aria-hidden="true">&times;</span></button>
			</div>	
			<form id="form-compraVenda">	
			<div class="modal-body">


					<div>
						<textarea style=" width:765px; height:550px;" name="compraVenda" id="compraVenda" class="textareag"> </textarea>
					</div>
					<input type="hidden" name="id" value="{$id}">

					<small><div id="mensagem-compraVenda" align="center"></div></small>
...
function excluirServico(id){
    ...
    $.ajax({
        url: 'paginas/' + pag + "/salvar-compraVenda.php",
        type: 'POST',
        data: formData,
...
<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			function compraVenda(id, nome){
			    ...
			    $.ajax({
			        url: 'paginas/' + pag + "/texto_compraVenda.php",
			        method: 'POST',
			        data: {id_usuario, id},
			        dataType: "html",
