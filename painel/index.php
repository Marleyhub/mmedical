		...
		<div class="page">
							...
							<div class="main-header-left ">
								<div class="responsive-logo">
									<a href="index.php" class="header-logo">
										...
										<img src="../img/logo_painel.png" class="mobile-logo dark-logo-1" alt="logo" style="width:40% !important; margin-left: -120px !important">
									</a>
								</div>
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide <?php echo @$menu_financeiro ?>">
									...
									<li class="<?php echo @$pagar ?>"><a class="slide-item" href="pagar"> Contas à Pagar</a></li>

										<li class="<?php echo @$receber ?>"><a class="slide-item" href="receber">Contas à Receber</a></li>
										...
										<li class="<?php echo @$comissoes ?>"><a class="slide-item" href="comissoes"> Comissoes</a></li>
										...
										<li class="<?php echo @$rel_lucro ?>"><a class="slide-item" href="" data-bs-toggle="modal" data-bs-target="#modalRelLucro">Detalhamento de Lucro</a></li>
								...
								<li class="slide <?php echo @$menu_produtos ?>">
									...
									<li class="<?php echo $categorias ?>"><a class="slide-item" href="categorias"> Categorias</a></li>
										...
										<li class="<?php echo $equipamentos ?>"><a class="slide-item" href="equipamentos"> Equipamento</a></li>

										<li class="<?php echo $marcas ?>"><a class="slide-item" href="marcas"> Marca</a></li>

										<!-- <li class="<?php echo $modelos ?>"><a class="slide-item" href="modelos">Modelo</a></li>
										-->
								...
								<li class="slide <?php echo @$vendas ?>">
									<a class="side-menu__item" data-bs-toggle="slide" href="vendas"><i class="fa fa-cash-register text-white mt-1"></i>
										<span class="side-menu__label" style="margin-left: 15px">Caixa</span></a>
								
								</li>

									<li class="slide <?php echo @$nova_os ?>">
									<a class="side-menu__item" href="nova_os.php">
										<i class="fa fa-file-circle-plus text-white"></i>
								...
								<li class="slide <?php echo @$orcamentos ?>">
									...
									<li class="slide <?php echo @$menu_os ?>">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i class="fa fa-file-lines text-white mt-1"></i>
										<span class="side-menu__label" style="margin-left: 15px">Ordem de Serviços</span><i class="angle fe fe-chevron-right"></i></a>
									<ul class="slide-menu">
									
										<li class="<?php echo $os ?>"><a class="slide-item" href="os"> OS Por Data</a></li>

										<li class="<?php echo $os_tecnico ?>"><a class="slide-item" href="os_tecnico"> Minhas OS</a></li>
			...
			<div class="main-footer">
				<div class="container-fluid pt-0 ht-100p">
					 Copyright © <?php echo date('Y'); ?> <a href="javascript:void(0);" class="text-primary">HugoCursos</a>. Todos os direitos reservados
				</div>
			</div>			<!-- FOOTER END -->
				...
				<div class="modal-header bg-primary text-white">
					...
					<div class="row">	
						<div class="col-md-12">							
							...
							<div>
							<textarea style="width: 1105px; height:200px;" id="msg_rodape" class="textareag" name="msg_rodape" placeholder="Mensagem de Agradecimento"><?php echo @$msg_rodape ?></textarea>
							</div>					
						</div>
					</div>
					...
					<div class="row" >					
						...
						<div class="col-md-12">						
							<div class="form-group"> 
								...
								<div>
								<textarea style="width: 1105px; height:200px;" id="garantia" class="textareag" name="garantia" ><?php echo $garantia ?></textarea>
								</div>
							</div>						
						</div>
					...
					<div class="row">					
						...
						<div class="col-md-12" >						
							<div class="form-group"> 
								<label>Termos</label> 
								<textarea style="width: 1105px; height:140px;" id="termos" class="textareag" name="termos"><?php echo $termos ?></textarea>
							</div>						
						</div>
