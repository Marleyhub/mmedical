...
<div id="header" >
	...
	<div style="border-style: solid; font-size: 10px; height:70px;">
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				<td style="border: 1px; solid #000; width: 50%; text-align: left;">
...
<table class="table table-striped borda" cellpadding="6">
  ...
  <tbody>
	...
	$total_devolucoesF = number_format($total_devolucoes, 2, ',', '.');
...
<td class="text-danger">R$ <?php echo $total_devolucoesF ?></td>
