...
<table class="printer-ticket">
	...
	<tr style="font-size: 11px">
		<th colspan="3"><b>CLIENTE:</b>	 <?php echo $nome_cliente ?><b> - Tel:</b> <?php echo $tel_cliente ?>						<?php if($nome_sec2 > 0){ ?>
...
$nome_produto = $res2[0]['nome'];
 ?>
	...
	<tfoot>
		...
		<tr >
		<th style="font-size: 12px" colspan="3">Data <?php echo $dataF ?>  /  Validade Proposta: <b><?php echo $dias_validade ?> Dias</b>  <br>  Previsão de Entrega <b><?php echo $data_entregaF ?></b>
		</th>
	</tr>
