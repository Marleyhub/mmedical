						...
						<div class="col-xl-5 col-lg-6 col-md-8 col-sm-8 col-xs-10 card-sigin-main mx-auto my-auto py-4 justify-content-center">
							<div class="card-sigin">
								 ...
								 <div class="main-card-signin d-md-flex">
									 <div class="wd-100p"><div class="d-flex mb-4 justify-content-center"><a href="index.html"><img src="img/logo.png" class="sign-favicon" alt="logo" width="130px"></a></div>
										 <div class="">
		...
		?>		
															   ...
															   <form method="post" action="autenticar.php">
																   <div class="form-group">
																	   <label>Usuário</label> 
																	   <input class="form-control" name="usuario" placeholder="Seu Email ou Telefone" type="text" id="usuario-email" required>
																   </div>
																   <div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#usuario-email').val(email_usuario);
